/*! EmojioneArea v3.1.5 | MIT license */ ! function(a, b, c) {
    "use strict";
    var d = 0,
        e = {},
        f = {},
    ...
    function s(c) {
        ...
        if (b.getSelection) {
            if (d = b.getSelection(), d.getRangeAt && d.rangeCount) {
                ...
                f.innerHTML = c;
                var g = a.createDocumentFragment(),
                    h, i;
    ...
    function H(a) {
        ...
        if (!a.recent || a.recent !== b) {
            if (b.length) {
                var d = a.scrollArea.is(".skinnable"),
                    e, f;
    ...
    function K(d, e, f) {
        ...
        var i = e.is("TEXTAREA") || e.is("INPUT") ? "val" : "text",
            k, q, t, y, z, K, L, M, N, O = F({
        ...
        if (N.on("scroll", function() {
                ...
                b ? (N.addClass("skinnable"), M.hide().filter("[data-tone=" + b + "]").show(), K.eq(0).is('.active[data-filter="recent"]') && K.eq(0).removeClass("active").next().addClass("active")) : (N.removeClass("skinnable"), M.hide().filter("[data-tone=0]").show(), K.eq(0).click()), D.call(d)
